...
const playerBulletController = new BulletController(canvas,18,"black",true);
...
{
    if(gameover){
        let text = win ? "YOU WIN YOUR GREAT PLAYER " : "GAMEOVER START WITH LEVEL 1";
     ...
     if(win){
        ...
        document.getElementById("lava3Id").href ="MOON1.html";
     }   
     if(!win){
