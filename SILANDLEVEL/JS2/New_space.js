...
const playerBulletController = new BulletController(canvas,18,"white",true);
const enemyBulletController =new BulletController(canvas,20,"#CCFF00",false);
...
function display()
{
    if(gameover){
     ...
     if(win){
        ...
        document.getElementById("s2").href ="New_space3.html";
     }   
     if(!win){
