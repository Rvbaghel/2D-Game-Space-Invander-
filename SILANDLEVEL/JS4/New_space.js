...
const playerBulletController = new BulletController(canvas,18,"blue",true);
const enemyBulletController =new BulletController(canvas,10,"green",false);
...
function display()
{
    if(gameover){
     ...
     if(win){
        ...
        document.getElementById("s4").href ="FLYJAT.html";
     }   
     if(!win){
