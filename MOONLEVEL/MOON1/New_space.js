...
function display()
{
    if(gameover){
     ...
     document.getElementById("MOON1Id").href ="MOON2.html";
     }   
     if(!win){
...
function checkgameover(){
    ...
    // if(gameover==true)
    // {
    //     alert("ENEMY WIN YOUR FAIL IN MISmsjdsdjlsSION GO TO RETRY ");
        
    // }
    // if(win)
    // {
    //     alert("ENEMY WIN YOUR FAIL IN MISSION GO TO RETRY ");
    //     document.getElementById("MOON1Id").href ="MOON1.html";   
    //     document.getElementById("MOON1Id").click();
